...
" WhichKey
call s:hi("WhichKey",              s:fg_function,  s:bg_panel,       s:fmt_none)
call s:hi("WhichKeySeperator",     s:fg_string,    s:bg_panel,       s:fmt_none)
call s:hi("WhichKeyGroup",         s:fg_keyword,   s:bg_panel,       s:fmt_bold)
call s:hi("WhichKeyDesc",          s:fg_fg,        s:bg_panel,       s:fmt_none)
call s:hi("WhichKeyFloat",         s:fg_fg,        s:bg_panel,       s:fmt_none)
call s:hi("WhichKeyValue",         s:fg_comment,   s:bg_panel,       s:fmt_none)
call s:hi("WhichKeyBorder",        s:fg_comment,   s:bg_panel,       s:fmt_none)

" Lualine
call s:hi("LualineMode",           s:fg_keyword,   s:bg_panel,       s:fmt_bold)
call s:hi("LualineModeNormal",     s:fg_bg,        s:fg_accent,      s:fmt_bold)
call s:hi("LualineModeInsert",     s:fg_bg,        s:fg_string,      s:fmt_bold)
call s:hi("LualineModeVisual",     s:fg_bg,        s:fg_constant,    s:fmt_bold)
call s:hi("LualineModeReplace",    s:fg_bg,        s:fg_markup,      s:fmt_bold)
call s:hi("LualineModeCommand",    s:fg_bg,        s:fg_keyword,     s:fmt_bold)
...
call s:hi("LualineFileStatus",     s:fg_comment,   s:bg_panel,       s:fmt_none)
call s:hi("LualineFileEncoding",   s:fg_comment,   s:bg_panel,       s:fmt_none)
call s:hi("LualineFileFormat",     s:fg_comment,   s:bg_panel,       s:fmt_none)
call s:hi("LualineFileType",       s:fg_function,  s:bg_panel,       s:fmt_none)
call s:hi("LualineDiagnosticError",s:fg_error,     s:bg_panel,       s:fmt_none)
call s:hi("LualineDiagnosticWarn", s:fg_accent,    s:bg_panel,       s:fmt_none)
call s:hi("LualineDiagnosticInfo", s:fg_fg_idle,   s:bg_panel,       s:fmt_none)
call s:hi("LualineDiagnosticHint", s:fg_constant,  s:bg_panel,       s:fmt_none)
...
call s:hi("LazyBorder",            s:fg_comment,   s:bg_none,        s:fmt_none)
